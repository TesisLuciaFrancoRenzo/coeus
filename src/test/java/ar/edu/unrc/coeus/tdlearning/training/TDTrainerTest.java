...
class TDTrainerTest {
    ...
    void testCase2() {
        ...
        try {
            ...
            try {
                ...
                TDTrainerPerceptron trainer2   = new TDTrainerPerceptron(perceptronInterface, lambda, 1d, false);
    ...
    /**
     * Test basico con caso de prueba numero 2 informe, class TDTrainerPerceptron. Se utilizaron las mismas formulas
     * pero el campo de las bias se forzo el valor cero.
     */
    @Test
    public
    void testCase2WithoutBias() {
        ...
        neuralNetwork.setWeight(0, 0, 0, 0.3);
        neuralNetwork.setWeight(0, 0, 1, 0.2);
        double expectedFinalWeight = -6.119615371341125e-4 + 0.2; //resultado obtenido mediante calculos manuales de w(j2,k1)
        neuralNetwork.setWeight(0, 1, 0, 0.1);
        neuralNetwork.setWeight(0, 1, 1, 0.9);
